...
void second()
{
    ...
    blue();
    printf("\n\n\n\t\t\t \xdb\xdb\xdb\xdb\xdb\xdb\xdb\xdb\xdb\xdb\xdb\xdb\xdb\xdb\xdb\xdb\xdb ADMIN PANEL \xdb\xdb\xdb\xdb\xdb\xdb\xdb\xdb\xdb\xdb\xdb\xdb\xdb\xdb\xdb\xdb\xdb");
    green();
    printf("\n\n\n\n\n\n\n\n\n\n\n\t\t\t LOADING...\n");
    printf("\t\t\t");
    for (i = 1; i <= 50; i++)
...
void third()
{
    ...
    blue();
    printf("\n\n\n\t\t\t \xdb\xdb\xdb\xdb\xdb\xdb\xdb\xdb\xdb\xdb\xdb\xdb\xdb\xdb\xdb\xdb\xdb CUSTOMER PANEL \xdb\xdb\xdb\xdb\xdb\xdb\xdb\xdb\xdb\xdb\xdb\xdb\xdb\xdb\xdb\xdb\xdb");
    green();
    printf("\n\n\n\n\n\n\n\n\n\n\n\t\t\t LOADING...\n");
    printf("\t\t\t");
    for (i = 1; i <= 50; i++)
...
void login()
{
    ...
    printf("\n\t\t\t\t\t***********************************************\n");
    system("cls");
    if ((strcmp(name, "haris") == 0) && (strcmp(pass, "182") == 0))
    {
        second();
        admin_menu();
    }

    else if ((strcmp(name, "moavia") == 0) && (strcmp(pass, "112") == 0))
    {
        second();
        admin_menu();
    }
